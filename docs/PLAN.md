...
- Linux：`.deb` Debian 安装包、`.dpkg` Debian 包别名、`.rpm` RPM 安装包、`.pkg.tar.xz` Arch Linux pacman 安装包。
...
- Arch Linux 用户可使用 `sudo pacman -U Elegant-Clock-*-Arch-x64.pkg.tar.xz` 安装 Release 中的 pacman 包。
